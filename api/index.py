...
def ns_player_playlist_converter(output_file_name:str,json_data:dict) -> str:
    ...
    for channel in json_data:
        ...
        "userAgent":"(Linux;Telegram:https://t.me/XFireFlix) Github:https://t.me/XFireFlix AndroidXMedia3/1.1.1/64103898/4d2ec9b8c7534adc",
         }
...
def home():
    ...
    table_html += """
            ...
            <footer>
                ♥️ Made BY <a href="https://t.me/XFireFlix" target="_blank">XFire Flix</a>
            </footer>
        </body>
    </html>
    """
...
@app.route("/api/aynaott/all_player.m3u")
def generate_hybrid_playlist():
    ...
    #FETCH ALL CHANNELS INFO FROM AYT
    ...
    for channel in channel_data_list_signed:
    	channel['link']=aynaott.hmac_hash_sign(channel["stream_url"],'xfire-flix',user_ip_addr,akamai_key)
...
def generate_stream_url():
    ...
    stream_url_signed=aynaott.hmac_hash_sign(stream_url,'xfire-flix',user_ip_addr,akamai_key)
